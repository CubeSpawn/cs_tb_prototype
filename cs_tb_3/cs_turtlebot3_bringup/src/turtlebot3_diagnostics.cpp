...
#include <cs_tb_3_msgs/SensorState.h>
#include <cs_tb_3_msgs/VersionInfo.h>
#include <string>
...
void sensorStateMsgCallback(const cs_tb_3_msgs::SensorState::ConstPtr &msg)
{
  if (msg->battery > 11.0)
  ...
  if (msg->button == cs_tb_3_msgs::SensorState::BUTTON0)
    setButtonDiagnosis(diagnostic_msgs::DiagnosticStatus::OK, "BUTTON 0 IS PUSHED");
  else if (msg->button == cs_tb_3_msgs::SensorState::BUTTON1)
...
void firmwareVersionMsgCallback(const cs_tb_3_msgs::VersionInfo::ConstPtr &msg)
{
  ...
  cs_tb_3_msgs::VersionInfo version;
...
int main(int argc, char **argv)
{
  ...
  tb3_version_info_pub = nh.advertise<cs_tb_3_msgs::VersionInfo>("version_info", 10);
